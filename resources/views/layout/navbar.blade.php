        ...
        <ul class="navbar-nav ml-auto">
                    ...
                    <div class="dropdown-menu dropdown-menu-right notification">
                        <div class="noti-head">
                            ...
                            <div class="float-right">
                                ...
                                <a href="javascript:void(0);" class="text-decoration-underline read-all-notification">clear all</a>
                            </div>
                        </div>
                        <ul class="noti-body">
                            @php
                            ...
                            $timePassed = '';
                            if ($timeDifference < 60) { $timePassed=$timeDifference . ' min' ; } else { $hours=floor($timeDifference / 60); $minutes=$timeDifference % 60; $timePassed=$hours . ' hours ' . $minutes . ' min' ; } $isNew=$timeDifference < 30; @endphp @if($isNew && !$newLabelDisplayed) <li class="n-title">
                                <p class="m-b-0">NEW</p>
            </li>
            ...
            <li class="notification">
                <a href="{{ route('notifications.read', base64_encode($notification->id)) }}">
                    <div class="media">
                        <img class="img-radius" src="{{ asset('storage/profile_pics/'.Auth()->User()->profile_pic) }}" alt="Generic placeholder image">
                        <div class="media-body">
                            <p><strong>{{ $notification->title }}</strong><span class="n-time text-muted"><i class="icon feather icon-clock m-r-10"></i>{{ $timePassed }}</span></p>
